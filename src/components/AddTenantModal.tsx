...
export function AddTenantModal({ open, onClose, onAdd }: AddTenantModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-display">Novo Inquilino</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Rating */}
          <div className="space-y-2">
            <Label className="text-base font-semibold">Avaliação Inicial</Label>
