...
export const mockTenants: Tenant[] = [
  ...
  {
    id: '10',
    name: 'Diego Martins Souza',
    document: '112.233.445-66',
    documentType: 'cpf',
    ...
    rating: 2,
    status: 'active',
    notes: 'Histórico de atrasos frequentes. Sempre paga com multa.',
  },
  {
    id: '11',
    name: 'Patrícia Rocha Lima',
    document: '556.677.889-00',
    documentType: 'cpf',
    email: 'patricia.rocha@email.com',
    phone: '(11) 96655-4433',
    guarantorName: 'Marcos Rocha',
    guarantorDocument: '778.899.001-22',
    hasInsurance: true,
    rating: 3,
    status: 'active',
    notes: 'Alguns meses com atraso, mas regulariza com juros.',
  },
  {
    id: '12',
    ...
    rating: 2,
    status: 'active',
    notes: 'Empresa com dificuldades financeiras. Atrasos recorrentes.',
  },
];
